-- Seeds a system-default category tree for every new user, and auto-creates
-- their profile row, via a trigger on auth.users. Keeps category ownership
-- per-user (never global/shared) per the commercialization-ready design rule.
...
begin
  -- Food & Dining
  insert into categories (user_id, name, system_default) values (p_user_id, 'Food & Dining', true) returning id into v_parent_id;
  insert into categories (user_id, name, parent_id, system_default) values
  ...
  -- Travel & Transport
  insert into categories (user_id, name, system_default) values (p_user_id, 'Travel & Transport', true) returning id into v_parent_id;
  insert into categories (user_id, name, parent_id, system_default) values
  ...
  -- Entertainment
  insert into categories (user_id, name, system_default) values (p_user_id, 'Entertainment', true) returning id into v_parent_id;
  insert into categories (user_id, name, parent_id, system_default) values
  ...
  -- Shopping
  insert into categories (user_id, name, system_default) values (p_user_id, 'Shopping', true) returning id into v_parent_id;
  insert into categories (user_id, name, parent_id, system_default) values
  ...
  -- Utilities
  insert into categories (user_id, name, system_default) values (p_user_id, 'Utilities', true) returning id into v_parent_id;
  insert into categories (user_id, name, parent_id, system_default) values
  ...
  -- Professional
  insert into categories (user_id, name, system_default) values (p_user_id, 'Professional', true) returning id into v_parent_id;
  insert into categories (user_id, name, parent_id, system_default) values
  ...
  -- Financial
  insert into categories (user_id, name, system_default) values (p_user_id, 'Financial', true) returning id into v_parent_id;
  insert into categories (user_id, name, parent_id, system_default) values
  ...
  -- Health
  insert into categories (user_id, name, system_default) values (p_user_id, 'Health', true) returning id into v_parent_id;
  insert into categories (user_id, name, parent_id, system_default) values
  ...
  -- Other
  insert into categories (user_id, name, system_default) values (p_user_id, 'Other', true) returning id into v_parent_id;
  insert into categories (user_id, name, parent_id, system_default) values
...
returns trigger as $$
begin
  insert into profiles (user_id, display_name) values (new.id, new.raw_user_meta_data->>'full_name');
...
-- Reference bank data (shared, not user-owned). Add more banks here as parsers are built.
insert into banks (name, code, statement_format, active) values
  ('HDFC Bank', 'HDFC', 'Standard HDFC credit card e-statement PDF', true)
